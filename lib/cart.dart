...
class CustomPesonWidget extends StatefulWidget {
  @override
  _CustomPesonWidgetState createState() => _CustomPesonWidgetState();
}

class _CustomPesonWidgetState extends State<CustomPesonWidget> {
...
class CartBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.fromLTRB(35,40,25,25),
      child: Column(
        children: <Widget>[
          CustomAppBar2(),
          title(),
